...
xcopy build-hextontiler-Desktop_Qt_5_10_1_MSVC2017_64bit-Release\release\hextontiler.exe bin
xcopy assets\icons\hextontiler_logo.ico bin\hextontiler.ico
xcopy ..\..\Libraries\boost-1.70.0-win-x64\lib\boost_regex-vc141-mt-x64-1_70.dll bin
