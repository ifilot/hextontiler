...
!define setup "hextontiler_installer_win64.exe"
 
; change this to wherever the files to be packaged reside
!define srcdir "."
 
!define company "Hextontiler"
 
!define prodname "hextontiler"
!define exec "hextontiler.exe"
